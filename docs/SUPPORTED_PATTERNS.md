# Ninja-Snatch v9.0 — Поддерживаемые паттерны анимаций

## Обзор

Ninja-Snatch автоматически обнаруживает и сохраняет анимации при экспорте блоков с веб-сайтов. В этом документе описаны все поддерживаемые паттерны и методы их обнаружения.
