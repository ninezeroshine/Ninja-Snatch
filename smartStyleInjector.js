 ...
 * 
 * This file is a copy of styleInjector.js with different export name.
 */
...
if (typeof window.__NINJA_SNATCH__.SmartStyleInjector !== 'undefined') {
    console.log('[Snatch] SmartStyleInjector already loaded, skipping...');
} else {

    /**
     * Browser-compatible SmartStyleInjector
     * This is a bundled version that doesn't require ES module support
     */
    const SmartStyleInjector = (() => {
        // ═══════════════════════════════════════════════════════════════
        // CONFIG
        // ═══════════════════════════════════════════════════════════════
        ...
        const _log = (level, ...args) => {
            ...
            console[level === 'error' ? 'error' : 'log'](`[SmartSnatch ${level.toUpperCase()}]`, ...args);
        };
...
${generateCursorScript()}
    ...
    // Export to namespace
    window.__NINJA_SNATCH__.SmartStyleInjector = SmartStyleInjector;

    // Legacy compatibility
    window.SmartStyleInjector = SmartStyleInjector;
