...
**Примечание:** GPT-5.2 Codex и Gemini 3 Pro — модели конца 2025 года. На момент разработки использовать:
- **GPT-4o** / **Claude 3.5 Sonnet** для логики
- **Gemini 2.0 Flash** для контекста и анимаций
